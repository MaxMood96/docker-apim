...
This section defines the step-by-step instructions to build an [Alpine](https://hub.docker.com/_/alpine/) Linux based Docker image for WSO2 API Manager - Traffic Manager 4.7.0.
...
```
docker build -t wso2am-tm:4.7.0-alpine .
```
...
```
docker run -it -p 9443:9443 -p 9611:9611 -p 5672:5672 -p 9711:9711 wso2am-tm:4.7.0-alpine
```
